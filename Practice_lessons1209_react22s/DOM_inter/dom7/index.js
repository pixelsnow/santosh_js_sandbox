const getDivElements = () => document.querySelectorAll("div");
// TODO: return all the div elements

const getFooterLinks = () => document.querySelectorAll("#footer-wrapper a");
// TODO: return all the links that are in the footer-wrapper

const getAboutLinks = () => document.querySelectorAll('a[href="about.html"]');
