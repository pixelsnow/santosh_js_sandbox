 ...
 * @param {array} grades
 */
const getFirstGrade = (grades) => grades?.[0];

/**
 * @param {array} grades
 */
const getLastGrade = (grades) => grades?.[grades.length - 1];

/**
 * @param {array} grades
 */
const isTestTooEasy = (grades) => grades.some((grade) => grade === 20);

/**
 * @param {array} grades
 * @param {number} grade
 */
const gradeExists = (grades, grade) => grades.some((g) => g == grade);

/**
 * @param {array} grades
 */
const exportCSV = (grades) => grades.toString();
